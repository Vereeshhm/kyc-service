...
@EnableJpaRepositories(entityManagerFactoryRef = "casEntityManagerFactory", transactionManagerRef = "casTransactionManager", basePackages = {
		"com.saswat.kyc.repository" })
public class CasDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.saswat.kyc.model") // Ensure this package contains your
																				// entities
				.persistenceUnit("casTxnPU").properties(properties).build();
	}
