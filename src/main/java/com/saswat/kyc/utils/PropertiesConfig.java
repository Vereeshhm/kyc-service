...
public class PropertiesConfig {
	...
	@Value("${individualpan.token}")
	private String individualpantoken;
	...
	public String getIndividualpantoken() {
		return individualpantoken;
	}

	public void setIndividualpantoken(String individualpantoken) {
		this.individualpantoken = individualpantoken;
	}
	...
	public String getAaadhar_Token() {
		return Aaadhar_Token;
	}

	public void setAaadhar_Token(String aaadhar_Token) {
		Aaadhar_Token = aaadhar_Token;
	}
