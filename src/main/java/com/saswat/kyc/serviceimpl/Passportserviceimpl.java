...
public class Passportserviceimpl implements Passportservice {
	...
	@Override
	public ResponseEntity<String> getVerify(PassportVerificationDto passportVerificationDto) {
	...
	@Override
	public ResponseEntity<String> getDetails(PassportNumberDto pasportdto) {
